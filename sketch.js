...
function setup() {
	...
	mango2 = new Mango(620,300,25);
	mango3 = new Mango(650,350,25);
	mango4 = new Mango(500,330,25);
	mango5 = new Mango(700,340,25);
	mango6 = new Mango(720,300,25);
	mango7 = new Mango(750,250,25);
	mango8 = new Mango(800,340,25);
	mango9 = new Mango(720,400,25);
	mango10 = new Mango(850,350,25);

	ground=new Ground(500,796,2000,5);

	stone = new Stone(95,690,50,50);

	rope = new Rope(stone.body,{x:95,y:690});
